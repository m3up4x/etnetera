    ...
    override fun onClick(p0: View?) {
        when (p0?.id) {
            R.id.ButtonSaveISRFL -> {
               ...
               val sportRecord = SportRecord(objectid,editTextName.text.toString(),editTextLocation.text.toString(),editTextHours.text.toString().toInt(),editTextMinutes.text.toString().toInt(),editTextSeconds.text.toString().toInt())
